...
import * as assignmentDb from "@/lib/db/actions/assignments"
import * as classGroupDb from "@/lib/db/actions/class-groups"
import * as courseTypeDb from "@/lib/db/actions/course-types"
import * as courseDb from "@/lib/db/actions/courses"
import * as scheduleDb from "@/lib/db/actions/schedules"
import * as shiftDb from "@/lib/db/actions/shifts"
import * as spaceTypeDb from "@/lib/db/actions/space-types"
import * as spaceDb from "@/lib/db/actions/spaces"
import * as subjectDb from "@/lib/db/actions/subjects"
import * as userDb from "@/lib/db/actions/users"
...
jest.mock("@/lib/db/idempotency", () => ({ runOnce: jest.fn() }))
jest.mock("@/lib/db/actions/shifts", () => ({
  createShift: jest.fn(),
  updateShift: jest.fn(),
  removeShift: jest.fn(),
}))
jest.mock("@/lib/db/actions/course-types", () => ({
  createCourseType: jest.fn(),
  updateCourseType: jest.fn(),
  removeCourseType: jest.fn(),
}))
jest.mock("@/lib/db/actions/space-types", () => ({
  createSpaceType: jest.fn(),
  updateSpaceType: jest.fn(),
  removeSpaceType: jest.fn(),
}))
jest.mock("@/lib/db/actions/courses", () => ({
  createCourse: jest.fn(),
  updateCourse: jest.fn(),
  removeCourse: jest.fn(),
}))
jest.mock("@/lib/db/actions/spaces", () => ({
  createSpace: jest.fn(),
  updateSpace: jest.fn(),
  removeSpace: jest.fn(),
}))
jest.mock("@/lib/db/actions/subjects", () => ({
  createSubject: jest.fn(),
  updateSubject: jest.fn(),
  removeSubject: jest.fn(),
}))
jest.mock("@/lib/db/actions/class-groups", () => ({
  createClassGroup: jest.fn(),
  updateClassGroup: jest.fn(),
  removeClassGroup: jest.fn(),
}))
jest.mock("@/lib/db/actions/schedules", () => ({
  createSchedule: jest.fn(),
  updateSchedule: jest.fn(),
  removeSchedule: jest.fn(),
}))
jest.mock("@/lib/db/actions/users", () => ({
  createUser: jest.fn(),
  updateUser: jest.fn(),
  removeUser: jest.fn(),
}))
jest.mock("@/lib/db/actions/assignments", () => ({
